...
class Vaz2108 private constructor(color: String) : VazPlatform(color) {
    ...
    companion object : CarBuilder {
        ...
        override fun build(plates: Car.Plates): Vaz2108 = Vaz2108("Красный").apply {
            ...
            this.plates = plates
            this.tank = object : Tank {
                var liters: Int = 0

                override val mouth = TankMouth.build(FuelType.PETROL)

                override fun getContents() = liters

                override fun receiveFuel(liters: Int) {
                    this.liters += liters
                }
            }
            this.fuelMouth = tank.mouth
        }
    ...
    override lateinit var fuelMouth: TankMouth
    ...
    override fun toString(): String {
        return "Vaz2108(plates=$plates, wheelAngle=$wheelAngle, currentSpeed=$currentSpeed, currentFuel=${tank.getContents()})"
    }
    ...
    inner class VazOutput : CarOutput {
        ...
        override fun getFuelContents() = tank.getContents()
    }
}